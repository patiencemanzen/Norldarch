        ...
        <div class="items-center md:flex">
          @if ($errors->any())
            <p class="text-sm font-medium text-gray-900 md:my-0 dark:text-white">
                <span class="bg-red-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-red-500 dark:text-white hidden md:inline">New!</span>
