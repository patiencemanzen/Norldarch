<li class="mb-10 ml-4">
    ...
    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
        Uvalde Schools Plan For More School Cops, New Perimeter Fencing After Massacre.
    </h3>
    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
        The Uvalde, Texas, school district has revealed its plans to add additional
        school police officers and increase security measures after the shooting that
        left 19 students and two teachers dead at Robb Elementary in May.
    </p>
    ...
    <div id="accordion-open" data-accordion="open">
        ...
        <div class="inline-flex rounded-md" role="group">
            ...
            <button id="accordion-open-heading-1" data-accordion-target="#accordion-open-body-1" aria-expanded="false" aria-controls="accordion-open-body-1" type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border-t border-b border-r rounded-t-lg border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-green-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-green-500 dark:focus:text-white">
                99+
                Comments
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 ml-2 fill-current" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
